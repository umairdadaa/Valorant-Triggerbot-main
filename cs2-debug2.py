...
def main():
    ...
    print("=" * 50)
    print("CS2 TriggerBot - FIXED VERSION")
    print("=" * 50)
    ...
    # Remove debug prints for better performance
    # We'll only show important info
    
    while True:
        try:
            # Check if CS2 is in focus
            window_title = GetWindowText(GetForegroundWindow())
            if "Counter-Strike" not in window_title:
                time.sleep(0.1)
                continue
